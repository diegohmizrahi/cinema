	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<g:hasErrors bean="${seatInstance}">
				<bootstrap:alert class="alert-error">
				<ul>
					<g:eachError bean="${seatInstance}" var="error">
				...
				<fieldset>
					<g:form class="form-horizontal" action="edit" id="${seatInstance?.id}" >
						<g:hiddenField name="version" value="${seatInstance?.version}" />
						<fieldset>
							<f:all bean="seatInstance"/>
